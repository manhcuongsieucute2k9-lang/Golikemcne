...
\033[1;32mTools               :  Golike Snapchat Auto Click
...
if author == "":
  ...
  print(gl_mc + f"\033[1;32mNhập \033[1;33m1 \033[1;32mĐể Vào TOOL Golike snapchat ")
...
print(banner)
print("\033[1;32m╔════════════════════════════════════════════╗")
print("\033[1;32m║   \033[1;33mDANH SÁCH ACC snapchat TRONG ACC GOLIKE    \033[1;32m║")
print("\033[1;32m╚════════════════════════════════════════════╝")  
headers = {
...
def dsacc():
  if chontksnapchat.get("status") != 200:  
    ...
    quit()
  for i in range(len(chontksnapchat["data"])):
    print(gl_mc + f'\033[1;32m[\033[1;33m{i+1}\033[1;32m] \033[1;32msnapchat \033[1;33m| \033[1;93m {chontksnapchat["data"][i]["username"]} \033[1;33m| \033[1;32m \033[1;31m\033[1;32m Online')
dsacc() 
print(f"\033[1;32m═══════════════════════════════════")
while True:
  try:
    luachon = int(input("\033[1;0m==> \033[1;32mChọn tài khoản \033[1;33msnapchat \033[1;32mbạn muốn chạy: \033[1;33m"))
...
while True:
  try: 
    doiacc = int(input(f"\033[1;0m==> \033[1;32m Thất Bại Bao Nhiêu Lần Thì Đổi Acc snapchat: \033[1;33m"))
    break
  except:
...
while True:
    if checkdoiacc == doiacc:
        ...
        print(f"\033[1;32m════════════════════════════════════════════════════════")
        print(gl_mc + f"\033[1;31m Acc snapchat {dsaccloi} gặp vấn đề hoặc bị nhả🚨")
        print(f"\033[1;32m════════════════════════════════════════════════════════")
        dsacc()
        while True:
            try:
    ...
    try:
        if adbyn == "1":
            os.system(f'adb shell am start -n com.snapchat.android/.LandingPageActivity -a android.intent.action.VIEW -d "{link}" > /dev/null 2>&1')
        else:
            #os.system(f"termux-open-url {link}")
            os.system(f'am start -n com.snapchat.android/.LandingPageActivity -a android.intent.action.VIEW -d "{link}" > /dev/null 2>&1')

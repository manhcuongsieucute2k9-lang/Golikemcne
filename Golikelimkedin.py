...
def LINKEDIN():
    ...
    for data in checkaccount['data']:
        ...
        print(f'{gl_mc}\033[1;32m[\033[1;33m{i}\033[1;32m] \033[1;0m=> \033[1;32mTên Tài Khoản: \033[1;33m{usernametk} \033[1;33m| \033[1;32m {STATUS[-1]}')
    ...
    choose = int(input(gl_mc1+'\033[1;32mNhập Tài Khoản : '))
    os.system('cls' if os.name== 'nt' else 'clear')
    if choose >=1 or choose <= len(user_linkedin1) :
        user_Linkedin1 = user_linkedin1[choose-1:choose]
                    ...
                    if type == 'follow':
                        ...
                        if 'li:fsd_company' not in response and 'identityDashProfilesByMemberIdentity&quot;:{&quot;*elements&quot;:[&quot;urn:li:fsd_profile:' not in response:
                                    ...
                                    if check['success'] == True:
                                        ...
                                        chuoi = (
                                            f"{gl_mc}\033[1;33m{dem}\033[1;33m | "
                                            f"\033[1;32m{h}:{m}:{s}\033[1;33m | "
                                            f"\033[1;32mSuccess\033[1;33m | "
                                            f"\033[1;33mFollow\033[1;33m |"
                                            f"\033[1;32m Ẩn ID\033[1;33m | \033[1;32m+{prices} \033[1;33m| "
                                        ...
                                        print(chuoi) 
                                            ...
                                            if checkskipjob['status'] == 200:
                                                ...
                                                print(Fore.RED+str(message), end='\r')
                                                PARAMSr = {
                                                'ads_id' : ads_id,
                                                'account_id' : account_id,
                                                'object_id' : object_id ,
...
if checkurl1['status']== 200 :
    ...
    print('\033[1;31mĐĂNG NHẬP THẤT BẠI')
    os.remove('user.txt')
